      ...
      <section class="content">
         <div class="card">
            <div class="card-header">
               <button class="btn btn-sm btn-success  text-left" type="subumit" name="CAPNHAT">
                  <i class="fa fa-save" aria-hidden="true"></i>
                  Lưu
               </button>
               <a href="index.php?option=category" class="btn btn-sm btn-info  text-right">
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="mb-3">
                        ...
                        <input type="text" value="<?= $category->name; ?>" name="name" id="name" placettder="Nhập tên danh mục" class="form-control" onkeydown="handle_slug(this.value);">
                     </div>
                     <div class="mb-3">
                        <label>Slug</label>
