...
class Pagination
{
    ...
    public static function pageLink($total, $current, $limit, $url = '')
    {
        ...
        $html = "<ul class='pagination justify-center'>";
        if ($numPage == 1) {
            return '';
        }
        if ($current == 1) {
            ...
            $html .= "<li class='page-item'><a class='pâge-link' href='$url&page=1'>Trang đầu</a></li>";
            $html .= "<li class='page-item'><a class='pâge-link' href='$url&page=" . ($current - 1) . "'>Trước</a></li>";
        }
        if ($current <= 3) {
